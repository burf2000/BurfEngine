 ...
 * Only one Skybox instance should be present
 * 
 */
...
public class Skybox {
	...
	public static void init () {
		...
		manager.load("skybox.g3db", Model.class, modelParam);
		...
		//Load Skybox
		manager.load("xpos.png", Texture.class, skyTextureParam);
		manager.load("xneg.png", Texture.class, skyTextureParam);
		manager.load("ypos.png", Texture.class, skyTextureParam);
		manager.load("yneg.png", Texture.class, skyTextureParam);
		manager.load("zpos.png", Texture.class, skyTextureParam);
		manager.load("zneg.png", Texture.class, skyTextureParam);

		manager.finishLoading();

		model = manager.get("skybox.g3db", Model.class);
	...
	public static void createSkyBox () { //Texture xpos, Texture xneg, Texture ypos, Texture yneg, Texture zpos, Texture zneg
		...
		Texture ypos = manager.get("ypos.png", Texture.class);
		Texture yneg = manager.get("yneg.png", Texture.class);
		Texture zpos = manager.get("zpos.png", Texture.class);
		Texture zneg = manager.get("zneg.png", Texture.class);
